...
// Verificar scripts
checkFile('./android-setup.cjs', 'Script de configuración Android');
checkFile('./build-release.cjs', 'Script de build para Play Store');
checkFile('./generate-icons.cjs', 'Script de generación de iconos');
checkFile('./deploy-to-playstore.cjs', 'Script maestro de deploy');
...
if (errors.length > 0) {
  ...
  console.log('\n🔧 SOLUCIONES:');
  console.log('• Ejecuta: node android-setup.cjs (para configurar Android)');
  console.log('• Ejecuta: npm install (para instalar dependencias)');
  console.log('• Ejecuta: node generate-icons.cjs (para recursos gráficos)');
}
...
if (warnings.length > 0) {
  ...
  console.log('\n💡 RECOMENDACIONES:');
  console.log('• Ejecuta: node build-release.cjs (para generar AAB)');
...
console.log('• Script automático: node deploy-to-playstore.cjs');
