        ...
        <div className="mt-6 bg-white/10 backdrop-blur-sm rounded-lg p-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
            <div>
              ...
              <div className="text-sm text-blue-200">Líder: Gustavo Bolívar</div>
            </div>
            <div>
              <div className="text-2xl font-bold">22.1%</div>
              <div className="text-sm text-blue-200">Indecisos</div>
            </div>
            <div>
              <div className="text-2xl font-bold">±3.2%</div>
              <div className="text-sm text-blue-200">Margen de Error</div>
            </div>
            <div>
              <div className="text-2xl font-bold">3,200</div>
              <div className="text-sm text-blue-200">Muestra</div>
            </div>
          </div>
        </div>
      </div>
